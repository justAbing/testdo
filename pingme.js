...
============QuanX============
[rewrite_local]
^https:\/\/api\.pingmelite\.net\/app\/queryBalanceAndBonus url script-request-header https://raw.githubusercontent.com/fmz200/wool_scripts/main/Scripts/cookie/get_cookie.js
...
function buildUrl(path, capture) {
    ...
    return `https://api.pingmelite.net/app/${path}?${qs}`;
}
...
function buildHeaders(capture) {
    ...
    headers['Host'] = 'api.pingmelite.net';
